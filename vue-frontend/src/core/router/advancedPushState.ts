export interface AdvancedPopStateEventDetail {
    state: PopStateEvent
    direction: 'back' | 'forward'
}

export interface AdvancedPopStateEvent extends CustomEvent<AdvancedPopStateEventDetail> {

}

export function initAdvancedPushState() {
    ...
    function modifyStateFunction(func: any, n: number) {
    ...
    function modifyStateGetter(cls: any) {
        const {get} = Object.getOwnPropertyDescriptor(cls.prototype, 'state') as any
