...
import {
    TEntity,
    TEntityListResult, TUseEntityListQueryParams,
...
>(params: TUseEntityListQueryParams<TEntityType, TResult, TVariables>): TUseEntityRecordsetQueryReturn<TEntityType, TResult, TVariables> {
...
export function useEntityListQueryGenerator<
    TEntityType extends TEntity,
    TResult extends TEntityListResult<TEntityType>,
    TVariables extends OperationVariables
>(params: TUseEntityListQueryParams<TEntityType, TResult, TVariables>): (useParams: Partial<TUseEntityListQueryParams<TEntityType, TResult, TVariables>>) => TUseEntityRecordsetQueryReturn<TEntityType, TResult, TVariables> {
    return (useParams) => useEntityListQuery({
        ...useParams,
        ...params,
    })
}
