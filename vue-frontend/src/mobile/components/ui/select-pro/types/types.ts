...
import type {UiTextFieldProps} from "~ui/text-field";
...
export interface SelectProps<T = unknown> {
    ...
    optionsResolver?: (query: string) => Promise<OptionsType<T>>;
    optionInnerSlot?: any
    searchText?: string
}
...
export interface SelectRef<T = unknown> {
    ...
    selectOption: (option: OptionType, index?: number) => void
}
