...
const useBottomSheetModal = () => {
    return require("~ui/bottom-sheet-vendor").useBottomSheetModal()
}
...
const BottomSheetComponent = forwardRef<BottomSheet, BottomSheetProps>(
    function BottomSheet(props, ref) {
        ...
        const animatedIndex = useDerivedValue(() => {
            ...
            let currentIndex = isLayoutCalculated.value
                ? interpolate(
            ...
            if (animatedKeyboardState.value === KEYBOARD_STATE.SHOWN && currentIndex === -1) {
                if (animatedPosition.value > adjustedSnapPoints[adjustedSnapPoints.length - 1]) {
                    currentIndex = -0.99
                }
            }
        ...
        const handleCanCloseOnRouterBack = useCallback(() => {
            return closeOnRouterBack
        }, [closeOnRouterBack])
        ...
        useImperativeHandle(ref, () => ({
            ...
            canCloseOnRouterBack: handleCanCloseOnRouterBack,
        }));
        //#endregion
        ...
        const contentMaskContainerStyle = useMemo(
            () => [styles.contentMaskContainer, contentRounded && {
                ...
                <BottomSheetInternalProvider value={internalContextVariables}>
                    ...
                    >
                        ...
                        <BottomSheetContainer
                            ...
                            detached={detached}
                            overflowVisible={containerOverflowVisible}
