...
import { BadgeProps } from 'react-native-ui-lib';
import type { TabControllerBarProps } from './TabBar.types';
export interface TabControllerItemProps extends Pick<TabControllerBarProps, 'spreadItems'> {
    ...
    onItemRef?: (index: number, ref: any) => void
}
export interface Props extends TabControllerItemProps {
    index: number;
    targetPage: any;
