...
const getTabBarWidth = <T extends Route>({
                                             ...
                                             flattenedTabWidth,
                                             tabWidths,
                                         }: Pick<TabbarProps<T>, 'navigationState' | 'gap' | 'layout' | 'scrollEnabled'> & {
...
const normalizeScrollValue = <T extends Route>({
                                                   ...
                                                   value,
                                                   flattenedTabWidth,
                                               }: Pick<TabbarProps<T>, 'layout' | 'navigationState' | 'gap' | 'scrollEnabled'> & {
    tabWidths: Record<string, number>;
    value: number;
    flattenedTabWidth: FlattenedTabWidth;
}) => {
...
const getScrollAmount = <T extends Route>({
                                              ...
                                              flattenedTabWidth,
                                              tabWidths,
                                          }: Pick<TabbarProps<T>, 'layout' | 'navigationState' | 'scrollEnabled' | 'gap'> & {
    tabWidths: Record<string, number>;
    flattenedTabWidth: FlattenedTabWidth;
}) => {
    ...
    const renderItem = React.useCallback(
        ({item: route, index}: ListRenderItemInfo<T>) => {
            const props: TabBarItemProps<T> & { key: string } = {
                ...
                activeColor: route.activeColor || activeColor,
                inactiveColor: route.inactiveColor || inactiveColor,
