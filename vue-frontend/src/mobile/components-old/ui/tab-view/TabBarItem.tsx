...
export function TabBarItem<T extends Route>(props: Props<T>) {
  ...
  const onTouchStartLatest = useLatestCallback(onTouchStart ? onTouchStart : () => {});
  const onTouchEndLatest = useLatestCallback(onTouchEnd ? onTouchEnd : () => {});
  ...
  return (
    <MemoizedTabBarItemInternal
      ...
      onTouchStart={onTouchStartLatest}
      onTouchEnd={onTouchEndLatest}
