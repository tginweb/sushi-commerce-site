...
const InstagramStories = forwardRef<InstagramStoriesPublicMethods, InstagramStoriesProps>((
    ...
    const onStoriesChange = async () => {
        ...
        const promises = stories.map((story) => {
            ...
            try {
                Image.prefetch(seenStory.content)
            } catch (e) {

            }

            return true;
            //return seenStory.contentType !== 'video' ? Image.prefetch(seenStory.content) : true;
