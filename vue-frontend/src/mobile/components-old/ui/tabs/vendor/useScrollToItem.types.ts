...
type ScrollToSupportedViews = {}
type ScrollToResultProps<T> = any
...
export type ScrollToItemResultProps<T extends ScrollToSupportedViews> =
    Pick<ScrollToResultProps<T>, 'scrollViewRef'>
    & {
    /**
