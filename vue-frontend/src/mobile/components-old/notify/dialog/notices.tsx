...
import {ButtonSize, Checkbox, Text, View} from "react-native-ui-lib";
    ...
    >
        <View row gap-8>
            ...
            <View marginL-auto row gap-7 top>
                {isNew ?
                    <View top bg-primary centerV paddingH-4 paddingV-1 style={{borderRadius: 6}}><Text text-xs-r white>{date}</Text></View>
                    :
