...
import {ButtonSize, Checkbox, TabController, TabControllerItemProps, Text, View} from "react-native-ui-lib"
            ...
            <View flex marginT-16 style={{minHeight: 400}}>
                    ...
                    <View marginH-modalH gap-15>
                        ...
                        <View row>
                            ...
                            <View row style={{gap: 10}}>
                                <UiBtn label={'Установить'} size={ButtonSize.small} outline onPress={() => {
                                    debug.setInitialRoute(currentUrl)
                                }}/>
                                <UiBtn label={'Снять'} size={ButtonSize.small} outline onPress={() => {
                ...
                <TabController.TabPage index={5} lazy>
                    ...
                    <View paddingH-modalH gap-10>
                        <UiBtn label={'Стереть картинки'} size={ButtonSize.small} outline onPress={async () => {
