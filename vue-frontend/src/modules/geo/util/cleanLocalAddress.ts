...
export type CleanLocalAddressBehavior = boolean | 'region' | 'city'

export function cleanLocalAddress(address: Maybe<string>, behavior: CleanLocalAddressBehavior = true) {
